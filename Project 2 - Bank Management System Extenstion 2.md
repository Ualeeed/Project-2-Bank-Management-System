...
We added a Login Functions into the previous project :
...
enum PerfromTransactionsMenuOptions { eDeposit = 1, eWithdraw = 2, eShowTotalBalance = 3, eShowMainMenu = 4 };
...
vector<string> SplitString(string S1, string Delim)
{
    ...
    while ((pos = S1.find(Delim)) != std::string::npos)
    {
        ...
        S1.erase(0, pos + Delim.length());  /* erase() until pos and move to next word. */
    }
...
void PerfromTransactionsMenuOption(PerfromTransactionsMenuOptions TransactionMenuOption)
{
    switch (TransactionMenuOption)
    {
    case PerfromTransactionsMenuOptions::eDeposit:
    {
        system("cls");
        ShowDepositScreen();
    ...
    case PerfromTransactionsMenuOptions::eWithdraw:
    {
        system("cls");
        ShowWithDrawScreen();
        GoBackToTransactionsMenu();
    ...
    case PerfromTransactionsMenuOptions::eShowTotalBalance:
    {
        system("cls");
    ...
    case PerfromTransactionsMenuOptions::eShowMainMenu:
    {
...
void ShowTransactionsMenu()
{
    ...
    cout << "\t[4] Main Menu.\n";
    cout << "===========================================\n";
    PerfromTransactionsMenuOption((PerfromTransactionsMenuOptions)ReadTransactionsMenuOption());
}
